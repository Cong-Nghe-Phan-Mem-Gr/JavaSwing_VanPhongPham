...
public class SanphamBUS {
    ...
    public static ArrayList<SanphamDTO> dsspSelling;
    //public static ArrayList<SanphamDTO> dsspSelling;
    //public static ArrayList<LoaimonanDTO> dsloai;
    public static ArrayList<String> dsloai;
    ...
    public void docDsspSelling(){
        SanphamDAO data = new SanphamDAO();
        dsspSelling = new ArrayList<SanphamDTO>();
        dsspSelling = data.DocDsspSelling();
        ChiTietGiamBUS ctgbus = new ChiTietGiamBUS();
        SanphamBUS spbus = new SanphamBUS();
        ctgbus.docChitiet();
        for(SanphamDTO sp : spbus.dsspSelling){
    ...
    public void docDsmonanconban(){
        ...
        dsspconban = data.DocDssp();
        for(SanphamDTO a : dsspconban)
        {
            if(a.trangthai.equals("0"))
            {
                dsspconban.remove(a);
            }
        }
