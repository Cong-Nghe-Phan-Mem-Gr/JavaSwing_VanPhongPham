...
public class ThongKeGUI extends JPanel implements ActionListener,MouseListener{
    ...
    public void loadsp(){
        ...
        if(dsspSelling==null)a.docDsspSelling();
